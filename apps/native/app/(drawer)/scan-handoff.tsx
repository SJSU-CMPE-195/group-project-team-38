...
export default function ScanHandoffScreen() {
  ...
  const selectedMedication = scanContext.medications.find(
      ...
      <View className="py-6 gap-4">
        <Surface variant="secondary" className="rounded-xl p-5">
          <View className="gap-3">
            ...
            <Text className="text-sm leading-6 text-muted">
              Review the resolved patient and select one active medication from this patient only.
            </Text>
          </View>
        </Surface>
        ...
        {scanContext.medications.length === 0 ? (
          <Surface variant="secondary" className="rounded-xl p-5">
            <View className="gap-3">
              <Text className="text-base font-semibold text-foreground">No active medications</Text>
              <Text className="text-sm leading-6 text-muted">
          ...
          <Surface variant="secondary" className="rounded-xl p-5">
            <View className="gap-3">
              <Text className="text-base font-semibold text-foreground">Active medications</Text>
              <Text className="text-sm leading-6 text-muted">
        ...
        <Surface variant="secondary" className="rounded-xl p-5">
          <View className="gap-2">
            ...
            <Text className="text-sm leading-6 text-foreground">
              {selectedMedication
                ? `${selectedMedication.displayName} (${selectedMedication.rxNormCode})`
